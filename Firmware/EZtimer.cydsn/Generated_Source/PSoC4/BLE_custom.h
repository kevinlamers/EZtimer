...
#define CYBLE_SERVOS_SERVICE_INDEX   (0x00u) /* Index of Servos service in the cyBle_customs array */
#define CYBLE_SERVOS_SERVO_CONTROL_CHAR_INDEX   (0x00u) /* Index of Servo Control characteristic */
#define CYBLE_SERVOS_SERVO_CONTROL_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */


#define CYBLE_SERVOS_SERVICE_HANDLE   (0x000Cu) /* Handle of Servos service */
#define CYBLE_SERVOS_SERVO_CONTROL_CHAR_HANDLE   (0x000Eu) /* Handle of Servo Control characteristic */
#define CYBLE_SERVOS_SERVO_CONTROL_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x000Fu) /* Handle of Characteristic User Description descriptor */
