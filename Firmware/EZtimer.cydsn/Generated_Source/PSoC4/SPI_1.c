...
static void SPI_1_ScbModeStop(void)
{
    ...
    *******************************************************************************/
    void SPI_1_SetPins(uint32 mode, uint32 subMode, uint32 uartEnableMask)
    {
        ...
        {
            hsiomSel[SPI_1_RX_SDA_MOSI_PIN_INDEX] = SPI_1_HSIOM_I2C_SEL;
            hsiomSel[SPI_1_TX_SCL_MISO_PIN_INDEX] = SPI_1_HSIOM_I2C_SEL;
        ...
        {
            hsiomSel[SPI_1_RX_SDA_MOSI_PIN_INDEX] = SPI_1_HSIOM_SPI_SEL;
            hsiomSel[SPI_1_TX_SCL_MISO_PIN_INDEX] = SPI_1_HSIOM_SPI_SEL;
            hsiomSel[SPI_1_CTS_SCLK_PIN_INDEX] = SPI_1_HSIOM_SPI_SEL;
            ...
            if (SPI_1_SPI_SLAVE == subMode)
            {
                ...
                hsiomSel[SPI_1_RTS_SS0_PIN_INDEX] = SPI_1_HSIOM_SPI_SEL;
        ...
        else /* UART */
        {
            ...
            {
                /* SmartCard */
                hsiomSel[SPI_1_TX_SCL_MISO_PIN_INDEX] = SPI_1_HSIOM_UART_SEL;
                pinsDm  [SPI_1_TX_SCL_MISO_PIN_INDEX] = SPI_1_PIN_DM_OD_LO;
            }
            else /* Standard or IrDA */
            {
                ...
                {
                    hsiomSel[SPI_1_RX_SDA_MOSI_PIN_INDEX] = SPI_1_HSIOM_UART_SEL;
                    pinsDm  [SPI_1_RX_SDA_MOSI_PIN_INDEX] = SPI_1_PIN_DM_DIG_HIZ;
                }
                ...
                if (SPI_1_UART_MODE_STD == subMode)
                {
                    if (0u != (SPI_1_UART_CTS_PIN_ENABLE & uartEnableMask))
                    {
                        ...
                        hsiomSel[SPI_1_CTS_SCLK_PIN_INDEX] = SPI_1_HSIOM_UART_SEL;
                        pinsDm  [SPI_1_CTS_SCLK_PIN_INDEX] = SPI_1_PIN_DM_DIG_HIZ;
                    }
                    ...
                    if (0u != (SPI_1_UART_RTS_PIN_ENABLE & uartEnableMask))
                    {
                        ...
                        hsiomSel[SPI_1_RTS_SS0_PIN_INDEX] = SPI_1_HSIOM_UART_SEL;
                        pinsDm  [SPI_1_RTS_SS0_PIN_INDEX] = SPI_1_PIN_DM_STRONG;
