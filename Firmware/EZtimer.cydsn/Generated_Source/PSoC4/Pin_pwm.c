...
#define SetP4PinDriveMode(shift, mode)  \
    do { \
        Pin_pwm_PC =   (Pin_pwm_PC & \
                                (uint32)(~(uint32)(Pin_pwm_DRIVE_MODE_IND_MASK << (Pin_pwm_DRIVE_MODE_BITS * (shift))))) | \
                                (uint32)((uint32)(mode) << (Pin_pwm_DRIVE_MODE_BITS * (shift))); \
    } while (0)
...
{
	SetP4PinDriveMode(Pin_pwm__0__SHIFT, mode);
}
