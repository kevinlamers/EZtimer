...
//    CyDelay(300u);
    ...
    CyDelay(time1*10u);
    PWM_12_WriteCompare1(servo1_pos1);
    CyDelay(time2*10u);
    PWM_12_WriteCompare1(servo1_pos2);
    CyDelay(time3*10u);
    PWM_12_WriteCompare1(servo1_pos3);
    CyDelay(time4*10u);
    PWM_12_WriteCompare1(servo1_pos4);
    CyDelay(time5*10u);
    PWM_12_WriteCompare1(servo1_pos5);
    CyDelay(time6*10u);
    PWM_12_WriteCompare1(servo1_pos6);
    CyDelay(time7*10u);
    PWM_12_WriteCompare1(servo1_pos7);
    CyDelay(time8*10u);
    PWM_12_WriteCompare1(servo1_pos8);
    CyDelay(time9*10u);
    PWM_12_WriteCompare1(servo1_pos9);
    CyDelay(time10*10u);
    PWM_12_WriteCompare1(servo1_pos10);
    if (timecum<timeDT){
        CyDelay((timeDT-timecum)*10u);
    }
    PWM_12_WriteCompare1(servo1_posDT);
    CyDelay(1000u);
    PWM_12_WriteCompare1(servo1_posStart);
    CyDelay(1000u);
    PWM_12_Stop();
