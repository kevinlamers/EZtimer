// ======================================================================
// EZtimer.v generated from TopDesign.cysch
// 12/11/2015 at 10:10
...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=false, Compare1_8=false, Compare2_16=true, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=1500, CompareValue2=1500, CONTROL3=0, ControlReg=true, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=0, KillModeMinTime=0, MinimumKillTime=1, OneCompare=false, Period=9999, PWMMode=1, PWMModeCenterAligned=0, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=true, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=true, TermVisibility_kill=false, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=false, TermVisibility_pwm1=true, TermVisibility_pwm2=true, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=true, UDB8=false, UseControl=true, UseInterrupt=true, UseStatus=true, VerilogSectionReplacementString=sP16, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=PWM_v3_30, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM_34, CY_INSTANCE_SHORT_NAME=PWM_34, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3, INSTANCE_NAME=PWM_34, )
module PWM_v3_30_1 (
    pwm2,
    tc,
    clock,
...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=false, Compare1_8=false, Compare2_16=true, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=1500, CompareValue2=1500, CONTROL3=0, ControlReg=true, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=0, KillModeMinTime=0, MinimumKillTime=1, OneCompare=false, Period=9999, PWMMode=1, PWMModeCenterAligned=0, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=true, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=true, TermVisibility_kill=false, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=false, TermVisibility_pwm1=true, TermVisibility_pwm2=true, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=true, UDB8=false, UseControl=true, UseInterrupt=true, UseStatus=true, VerilogSectionReplacementString=sP16, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=PWM_v3_30, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM_12, CY_INSTANCE_SHORT_NAME=PWM_12, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3, INSTANCE_NAME=PWM_12, )
module PWM_v3_30_3 (
    pwm2,
    tc,
    clock,
...
module top ;
	...
	wire [0:0] tmpOE__Pin_servo4_net;
	wire [0:0] tmpFB_0__Pin_servo4_net;
	wire [0:0] tmpIO_0__Pin_servo4_net;
	wire [0:0] tmpINTERRUPT_0__Pin_servo4_net;
	electrical [0:0] tmpSIOVREF__Pin_servo4_net;

	cy_psoc3_pins_v1_10
		#(.id("686f9e31-9cfd-4eaa-850a-b4f975c2633f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_servo4
		 (.oe(tmpOE__Pin_servo4_net),
		  .y({Net_2189}),
		  .fb({tmpFB_0__Pin_servo4_net[0:0]}),
		  .io({tmpIO_0__Pin_servo4_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_servo4_net),
		  .interrupt({tmpINTERRUPT_0__Pin_servo4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_servo4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_beep_net;
	wire [0:0] tmpFB_0__Pin_beep_net;
	wire [0:0] tmpIO_0__Pin_beep_net;
	wire [0:0] tmpINTERRUPT_0__Pin_beep_net;
	electrical [0:0] tmpSIOVREF__Pin_beep_net;

	cy_psoc3_pins_v1_10
		#(.id("f3341466-1246-41d2-913d-99857d80c4ac"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_beep
		 (.oe(tmpOE__Pin_beep_net),
		  .y({Net_1561}),
		  .fb({tmpFB_0__Pin_beep_net[0:0]}),
		  .io({tmpIO_0__Pin_beep_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_beep_net),
		  .interrupt({tmpINTERRUPT_0__Pin_beep_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_beep_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpFB_0__InputPin_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("dd517ad6-8077-4fee-b98c-1359d731514a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("76df910c-60c7-462b-b7ad-8006291e67e3"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("d2b04b9e-d2fe-404d-afba-e7a8674b1f45"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Pin_servo3_net;
	wire [0:0] tmpFB_0__Pin_servo3_net;
	wire [0:0] tmpIO_0__Pin_servo3_net;
	wire [0:0] tmpINTERRUPT_0__Pin_servo3_net;
	electrical [0:0] tmpSIOVREF__Pin_servo3_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_servo3
		 (.oe(tmpOE__Pin_servo3_net),
		  .y({Net_2188}),
		  .fb({tmpFB_0__Pin_servo3_net[0:0]}),
		  .io({tmpIO_0__Pin_servo3_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_servo3_net),
		  .interrupt({tmpINTERRUPT_0__Pin_servo3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_servo3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_servo2_net;
	wire [0:0] tmpFB_0__Pin_servo2_net;
	wire [0:0] tmpIO_0__Pin_servo2_net;
	wire [0:0] tmpINTERRUPT_0__Pin_servo2_net;
	electrical [0:0] tmpSIOVREF__Pin_servo2_net;

	cy_psoc3_pins_v1_10
		#(.id("21d09c1b-aea3-4785-91bc-6e38578a17dc"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_servo2
		 (.oe(tmpOE__Pin_servo2_net),
		  .y({Net_3525}),
		  .fb({tmpFB_0__Pin_servo2_net[0:0]}),
		  .io({tmpIO_0__Pin_servo2_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_servo2_net),
		  .interrupt({tmpINTERRUPT_0__Pin_servo2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_servo2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    PWM_v3_30_1 PWM_34 (
        ...
        .ph1(Net_2196),
        .ph2(Net_2197));
    defparam PWM_34.Resolution = 16;


	cy_clock_v1_0
		#(.id("675ab7a3-c127-4f5e-93c5-4b0e02195b50"),
	...
	wire [0:0] tmpOE__Pin_servo1_net;
	wire [0:0] tmpFB_0__Pin_servo1_net;
	wire [0:0] tmpIO_0__Pin_servo1_net;
	wire [0:0] tmpINTERRUPT_0__Pin_servo1_net;
	electrical [0:0] tmpSIOVREF__Pin_servo1_net;

	cy_psoc3_pins_v1_10
		#(.id("624e730a-922e-41f8-8c07-9a17c5adcfc9"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_servo1
		 (.oe(tmpOE__Pin_servo1_net),
		  .y({Net_3491}),
		  .fb({tmpFB_0__Pin_servo1_net[0:0]}),
		  .io({tmpIO_0__Pin_servo1_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_servo1_net),
		  .interrupt({tmpINTERRUPT_0__Pin_servo1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_servo1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
