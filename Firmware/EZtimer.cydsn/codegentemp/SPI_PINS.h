...
#if (SPI_RX_WAKE_SDA_MOSI_PIN)
    #define SPI_RX_WAKE_SDA_MOSI_HSIOM_REG \
                            (*(reg32 *) SPI_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM)
    #define SPI_RX_WAKE_SDA_MOSI_HSIOM_PTR \
                            ( (reg32 *) SPI_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM)
    #define SPI_RX_WAKE_SDA_MOSI_HSIOM_MASK \
                            (SPI_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM_MASK)
    #define SPI_RX_WAKE_SDA_MOSI_HSIOM_POS \
                            (SPI_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM_SHIFT)

    #define SPI_RX_WAKE_SDA_MOSI_INTCFG_REG \
                            (*(reg32 *) SPI_uart_rx_wake_i2c_sda_spi_mosi__0__INTCFG)
    #define SPI_RX_WAKE_SDA_MOSI_INTCFG_PTR \
                            ( (reg32 *) SPI_uart_rx_wake_i2c_sda_spi_mosi__0__INTCFG)
    #define SPI_RX_WAKE_SDA_MOSI_INTCFG_TYPE_POS  (SPI_uart_rx_wake_i2c_sda_spi_mosi__SHIFT)
    #define SPI_RX_WAKE_SDA_MOSI_INTCFG_TYPE_MASK \
