    ...
    const CYBLE_GATTS_T cyBle_gatts =
{
    ...
    /* Device Name */
    (uint8)'S', (uint8)'i', (uint8)'m', (uint8)'p', (uint8)'l', (uint8)'e', (uint8)'T', (uint8)'i', (uint8)'m', (uint8)'e',
(uint8)'r', 
...
0x00u, 
    ...
    (uint8)'S', (uint8)'e', (uint8)'r', (uint8)'v', (uint8)'o', (uint8)' ', (uint8)'C', (uint8)'o', (uint8)'n', (uint8)'t',
(uint8)'r', (uint8)'o', (uint8)'l', 
...
const uint8 cyBle_attUuid128[][16u] = {
    ...
    /* Servo Control */
    { 0x1Bu, 0xC5u, 0xD5u, 0xA5u, 0x02u, 0x00u, 0x07u, 0x9Au, 0xE5u, 0x11u, 0xBFu, 0x95u, 0xE0u, 0xE8u, 0x30u, 0xC4u },
};
...
CYBLE_GATTS_ATT_GEN_VAL_LEN_T cyBle_attValuesLen[CYBLE_GATT_DB_ATT_VAL_COUNT] = {
    ...
    { 0x0010u, (void *)&cyBle_attUuid128[0] }, /* Servos UUID */
    { 0x0010u, (void *)&cyBle_attUuid128[1] }, /* Servo Control UUID */
    { 0x0034u, (void *)&cyBle_attValues[25] }, /* Servo Control */
    { 0x000Du, (void *)&cyBle_attValues[77] }, /* Characteristic User Description */
};
...
const CYBLE_GATTS_DB_T cyBle_gattDB[0x0Fu] = {
    ...
    { 0x000Eu, 0xe8e0u /* Servo Control                       */, 0x00090A04u /* rd,wr  */, 0x000Fu, {{0x0034u, (void *)&cyBle_attValuesLen[7]}} },
    { 0x000Fu, 0x2901u /* Characteristic User Description     */, 0x00010201u /* rd     */, 0x000Fu, {{0x000Du, (void *)&cyBle_attValuesLen[8]}} },
};
